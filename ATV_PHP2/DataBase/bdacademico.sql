...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/06/2023 às 19:12
...
INSERT INTO `aluno` (`idAluno`, `nomeAluno`, `matriculaAluno`) VALUES
(1, 'Flora', '45678912'),
(2, 'João', '11111111');
...
(1, 'fhgjdjddx', 'kjgkv245', 123, 65478912, 1, NULL),
(2, 'fhgjdjddx', 'kjgkv245', 123, 45667812, 2, NULL);
...
INSERT INTO `matricula` (`idMatricula`, `id_Disciplina`, `id_Curso`, `id_Aluno`) VALUES
(1, 2, 3, 1),
(2, 3, 3, 1),
(3, 2, 3, 2);
